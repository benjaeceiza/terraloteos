...
const FormularioContacto = () => {
    ...
    // Toasts configurados
    const notifySuccess = () => toast.success('¡Mensaje enviado con éxito!', { theme: "dark" });
    const notifyError = () => toast.error('Error al enviar. Intenta nuevamente.', { theme: "dark" });

    const sendEmail = (e) => {
        e.preventDefault();
        setIsSending(true);

        emailjs.sendForm('service_9bojsir', 'template_n3yh8h7', form.current, {
